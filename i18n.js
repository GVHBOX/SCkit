window.SCKIT_I18N = {
  zh: {
    ...
    sec_anim: '动画', tilt_label: '倾斜幅度', swap_anim: '切换音乐', hover_ring: '悬停白色描边',
    ...
    pos_label: '位置', pos_left: '左', pos_center: '中', pos_right: '右',
  ...
  en: {
    ...
    sec_anim: 'Animation', tilt_label: 'Tilt', swap_anim: 'Track switch', hover_ring: 'Hover white ring',
    ...
    pos_label: 'Position', pos_left: 'Left', pos_center: 'Center', pos_right: 'Right',
